...
def restaurant(location):
    ...
    url = 'https://discover.search.hereapi.com/v1/discover?in=circle:{},{};r=10000&limit=100&q=restaurant&apiKey=uJHMEjeagmFGldXp661-pDMf4R-PxvWIu7I68UjYC5Q'.format(latpoint,longpoint)
    ...
    if d.empty or d['title'].count() < 3:
        ...
        map_rest.save("D:/jupyter/templates/restmapResult.html")
