...
def atms(location):
    ...
    url = 'https://discover.search.hereapi.com/v1/discover?in=circle:{},{};r=5000&limit=100&q=atm&apiKey=uJHMEjeagmFGldXp661-pDMf4R-PxvWIu7I68UjYC5Q'.format(latpoint,longpoint)
    ...
    if d.empty or d['title'].count() < 3:
        ...
        map_rest.save("D:/jupyter/templates/atmmapResult.html")
        return "This is empty one"
    else :
        map_rest=folium.Map(location=[latpoint,longpoint],zoom_start=14)
